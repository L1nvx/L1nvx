...
def main():
	...
	sleep(0.7)
	print(str('\n'.join([str(Style.BRIGHT + Fore.GREEN + "[+] " + Fore.YELLOW + "Payload " + str(k) + ' ' +Fore.WHITE) + str(g) for k,g in enumerate(payloads)]).replace('localhost',args.Ip + port)))
	sleep(1)
